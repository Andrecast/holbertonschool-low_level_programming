...
At the end of this project, you are expected to be able to  [explain to anyone](https://intranet.hbtn.io/rltoken/K2Pqe2sA3L9LV9u0N_MgNQ "explain to anyone"),  **without the help of Google**:
...
julien@ubuntu:~/0x07$ gcc -Wall -pedantic -Werror -Wextra -std=gnu89 9-main.c 9-set_string.c -o 9-set_string
