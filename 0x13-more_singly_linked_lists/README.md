...
At the end of this project, you are expected to be able to  [explain to anyone](https://intranet.hbtn.io/rltoken/njPzApNnOBMJVIINJ-aHTw "explain to anyone"),  **without the help of Google**:
...
Score:  79.00%  (Checks completed: 100.00%)
